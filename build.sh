...
/usr/libexec/PlistBuddy -c 'Add CFBundleShortVersionString string 2.4.3' "$APP_DST/Contents/Info.plist"
/usr/libexec/PlistBuddy -c 'Add CFBundleVersion string 2.4.3' "$APP_DST/Contents/Info.plist"
