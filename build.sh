...
/usr/libexec/PlistBuddy -c 'Add CFBundleShortVersionString string 2.0' "$APP_DST/Contents/Info.plist"
/usr/libexec/PlistBuddy -c 'Add CFBundleVersion string 2.0' "$APP_DST/Contents/Info.plist"
